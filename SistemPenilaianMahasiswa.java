...
public class SistemPenilaianMahasiswa {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Jumlah Mahasiswa yg Tidak Lulus : " + tidakLulus + " yaitu " + String.join(", ", namaTidakLulus));

        System.out
                .println("Jumlah Mahasiswa dengan Nilai A : " + gradeA.size() + " yaitu " + String.join(", ", gradeA));
        System.out
                .println("Jumlah Mahasiswa dengan Nilai B : " + gradeB.size() + " yaitu " + String.join(", ", gradeB));
        System.out
                .println("Jumlah Mahasiswa dengan Nilai C : " + gradeC.size() + " yaitu " + String.join(", ", gradeC));
        System.out
                .println("Jumlah Mahasiswa dengan Nilai D : " + gradeD.size() + " yaitu " + String.join(", ", gradeD));
        System.out
                .println("Jumlah Mahasiswa dengan Nilai E : " + gradeE.size() + " yaitu " + String.join(", ", gradeE));
